...
assert(bookingWizard.includes('trackBookingSchedule') && bookingWizard.includes("step === 3 && canContinue"), 'Schedule must follow successful progression past a valid booking date/time only.');
...
metaScope.exports.trackMetaPageView(bookingMetaUrl);
metaScope.exports.trackMetaInitiateCheckout(bookingMetaUrl);
metaScope.exports.trackMetaInitiateCheckout(bookingMetaUrl);
metaScope.exports.trackBookingSchedule('2026-09-10|10:00');
metaScope.exports.trackBookingSchedule('2026-09-10|10:00');
metaScope.exports.trackBookingCompletion('LOCAL_ONLY');
metaScope.exports.trackBookingCompletion('LOCAL_ONLY');
assert(JSON.stringify(observedMetaEvents) === '[["PageView"],["InitiateCheckout"],["Schedule"],["CompleteRegistration"]]', 'Booking funnel events must deduplicate and expose event names only.');
...
assert(observedMetaEvents.length === 5, 'Protected pages must not emit conversions.');
