...
export function PublicBookingTracker() {
  ...
  return (
    <main className="min-h-[78vh] bg-[radial-gradient(circle_at_top_right,rgba(14,124,134,0.12),transparent_34%),linear-gradient(180deg,#F7FBFC_0%,#FFFFFF_58%,#F4F8F9_100%)] py-12 sm:py-16">
