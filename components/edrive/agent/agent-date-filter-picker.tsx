...
type AgentDateFilterPickerProps = {
  label: string;
  value: string;
  placeholder: string;
...
export function AgentDateFilterPicker({
  label,
  value,
  placeholder,
  onChange,
  ...
  return (
    <div className="grid min-w-0 gap-1.5 text-xs font-semibold text-slate-600">
      ...
      <div ref={pickerRef} className="relative min-w-0">
        ...
        {open ? (
          <div role="dialog" aria-label={`${label} calendar`} className="absolute right-0 top-[calc(100%+0.5rem)] z-40 w-[min(20rem,calc(100vw-2rem))] rounded-2xl border border-slate-200 bg-white p-3.5 shadow-[0_20px_55px_rgba(15,23,42,0.18)]">
