...
export default function AgentDashboardPage() {
  ...
  return <AgentPortalShell profile={profile} walletBalance={summary?.wallet_balance_aed}>
    ...
    <section className="mt-5 rounded-2xl bg-slate-950 p-5 text-white shadow-[0_14px_35px_rgba(15,23,42,0.16)] sm:flex sm:items-center sm:justify-between sm:gap-6">
